<script lang="ts">
	...
	const socials = [
		...
		{
			name: 'YouTube',
			href: 'https://www.youtube.com/@bchworks',
			path:
		...
		{
			name: 'Instagram',
			href: 'https://www.instagram.com/bchworks',
			path:
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
		<div class="grid gap-8 md:grid-cols-5">
			<div class="md:col-span-2">
				...
				<p class="mt-3 text-sm text-slate-600 dark:text-slate-300 max-w-sm">
				...
				<a
					...
					class="mt-3 inline-block text-sm text-slate-700 dark:text-slate-200 hover:text-violet-600 dark:hover:text-violet-400"
				>
					hello@panmoni.com
				</a>
			</div>
			...
			<div>
				...
				<ul class="mt-4 space-y-2 text-sm">
					...
					<li><a href="/crc20" class="text-slate-600 dark:text-slate-300 hover:text-violet-600 dark:hover:text-violet-400">CRC-20</a></li>
					...
					<li><a href="/blocks" class="text-slate-600 dark:text-slate-300 hover:text-violet-600 dark:hover:text-violet-400">Blocks</a></li>
					<li><a href="/mining" class="text-slate-600 dark:text-slate-300 hover:text-violet-600 dark:hover:text-violet-400">Mining</a></li>
					<li><a href="/mint" class="text-slate-600 dark:text-slate-300 hover:text-violet-600 dark:hover:text-violet-400">Mint</a></li>
		...
		<Separator class="my-8 bg-slate-200 dark:bg-slate-800" />
				...
				{#each socials as s (s.name)}
					...
					>
						...
						<svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox={s.viewBox} xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd" d={s.path} />
						</svg>
					</a>
				{/each}
			</div>
		...
		<p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
			<strong class="text-slate-700 dark:text-slate-300">Disclaimer:</strong>
			...
			you could sustain a loss of some or all of your initial investment. Therefore, you should
