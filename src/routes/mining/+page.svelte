		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
			{#each [
				...
				<div class="rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
					<div class="px-4 py-3 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
					...
					{:else}
						{#each window.stats as p (p.pool)}
							<div class="grid grid-cols-[1.4fr_0.6fr_0.8fr] gap-2 px-4 py-2 border-b border-slate-100 dark:border-slate-800 last:border-b-0 items-center text-sm">
								...
								<div class="text-right font-mono text-xs text-slate-500 dark:text-slate-400">
	...
	<section class="mt-10 p-5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30">
		...
		<ul class="text-sm text-slate-600 dark:text-slate-400 space-y-1.5 list-disc list-inside">
			<li>
				...
				(<code class="text-xs px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 font-mono">/ViaBTC/</code>,
				<code class="text-xs px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 font-mono">/AntPool/</code>,
				<code class="text-xs px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 font-mono">Foundry USA Pool</code>, etc.). Solo miners and
